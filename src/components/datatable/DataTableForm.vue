        ...
        <form @submit.prevent="handleSubmit" class="form">
          ...
          >
            ...
            <template v-else-if="column.type === 'file'">
              <FileUpload
                :id="column.field"
                :accept="column.accept || '.glb'"
                :label="column.uploadLabel || 'Seleccionar archivo GLB'"
                @file-selected="handleFileSelect"
                @file-removed="handleFileRemoved"
              />
              <div
                v-if="formData[getFormFieldName(column)] && !selectedFile"
                class="current-file"
              >
                Archivo actual: {{ formData[getFormFieldName(column)] }}
              </div>
            </template>
            ...
            <template v-else>
              <input
                v-if="
                  !column.type ||
                  ['text', 'email', 'number'].includes(column.type)
                "
                :type="column.type || 'text'"
                :id="column.field"
